def sonarChecks() {
   stage('Sonar Checks') {
        ...
        sh "sonar-scanner -Dsonar.host.url=http://172.31.92.95:9000 -Dsonar.login=admin -Dsonar.password=password -Dsonar.projectKey=${COMPONENT} ${ARGS}"
        sh "bash -x sonar-quality-gate.sh admin password 172.31.92.95 ${COMPONENT}" 
